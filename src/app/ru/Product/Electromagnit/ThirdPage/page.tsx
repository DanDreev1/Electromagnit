...
export const metadata: Metadata = {
    ...
    title: "ЭМГ 117-39/А, ЭМГ 117-39/М",
    description: 'Лучшие грузовые электромагниты для любых нужд. Узнайте больше о наших продуктах и ​​услугах.',
    
    openGraph: {
        title: "ЭМГ 117-39/А, ЭМГ 117-39/М",
        description: 'Лучшие грузовые электромагниты для любых нужд. Узнайте больше о наших продуктах и ​​услугах.',
        url: 'https://electromagnit.vercel.app/ru/Product/Electromagnit/ThirdPage',
...
export default function Page() {
    return (
        <section className={styles.container}>
            <span className={styles.span}><Link className={styles.link} href="../../Product">Продукт</Link> {'>'} <Link className={styles.link} href="../Electromagnit">Электромагнит</Link> {'>'} ЭМГ 117-39/А, ЭМГ 117-39/М</span>
            <h2 className={styles.title}>Электромагниты грузоподъемные средней серии ЭМГ 117-39/А, ЭМГ 117-39/М</h2>
            ...
            <div className="overflow-x-auto">
                <table className={styles.thirdtable}>
                    ...
                    <tbody>
                        <tr>
                            <th className={styles.tableActiveMain}>ЭМГ 117-39/А</th>
                        ...
                        <tr>
                            <th className={styles.tableActiveMain}>ЭМГ 117-39/М</th>
                            <td className={styles.tableunactive}>1170</td>
                            <td className={styles.tableunactive}>390</td>
                            <td className={styles.tableunactive}>1300</td>
