...
export const metadata: Metadata = {
    ...
    title: "ЕМГ 117-32/А, ЕМГ 117-32/М",
    description: 'Найкращі вантажні електромагніти для будь-яких потреб. Дізнайтеся більше про наші продукти та послуги.',

    metadataBase: new URL('https://electromagnit.vercel.app/ua/Product/Electromagnit/FourthPage'),
    alternates: {
      canonical: '/ua',
      languages: {
        'en-GB': '/en',
...
export default function Page() {
    return (
        <section className={styles.container}>
            <span className={styles.span}><Link className={styles.link} href="../../Product">Продукт</Link> {'>'} <Link className={styles.link} href="../Electromagnit">Електромагніт</Link> {'>'} ЕМГ 117-32/А, ЕМГ 117-32/М</span>
            <h1 className={styles.title}>Електромагніти вантажопідйомні середньої серії ЕМГ 117-32/А, ЕМГ 117-32/М</h1>
                ...
                <table className={styles.thirdtable}>
                    <thead>
                        <tr>
                            ...
                            <th className={styles.tableActiveSubmain}>ЕМГ 117-32/А</th>
                            <th className={styles.tableActiveSubmain}>ЕМГ 117-32/М</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
            ...
            <div className="overflow-x-auto">
                <table className={styles.thirdtable}>
                    ...
                    <tbody>
                        <tr>
                            <th className={styles.tableActiveMain}>ЕМГ 117-32/А</th>
                        ...
                        <tr>
                            <th className={styles.tableActiveMain}>ЕМГ 117-32/М</th>
                            <td className={styles.tableunactive}>1170</td>
                            <td className={styles.tableunactive}>320</td>
                            <td className={styles.tableunactive}>1300</td>
